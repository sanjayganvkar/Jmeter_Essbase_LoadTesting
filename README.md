...
Essbase Japi.
The Use Case assumes that the Tester would like to simulate multiple users retrieving Essbase Data with the Excel-Addin retrieval or Smart view
based ones. The Sample.Basic Database has been used to demo the load test.
...
also be executed using Unix-Like Utility tools for Dos ).
